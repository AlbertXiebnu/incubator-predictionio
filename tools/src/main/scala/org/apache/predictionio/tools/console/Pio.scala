...
import org.apache.predictionio.tools.commands.{AdminServerArgs, BuildArgs, DashboardArgs, Engine, EngineArgs, Export, ExportArgs, FileUploadArgs, Import, ImportArgs, Management, AccessKey => AccessKeysCmd, App => AppCmd}
...
object Pio extends Logging {
  ...
  def fileuploadserver(fa: FileUploadArgs): Int = {
    Management.fileuploadserver(fa).awaitTermination
    0
  }
